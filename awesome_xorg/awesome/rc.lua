...
beautiful.init(gears.filesystem.get_themes_dir() .. "themedulan/theme.lua")
...
-- Widgets from awesome-wm-widgets github
...
local mem = lain.widget.mem({
	settings = function()
		widget:set_markup("RAM " .. tostring(mem_now.used / 1000) .. "Gb")
	end,
})
